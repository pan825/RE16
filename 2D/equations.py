...
Ach_eqs_EIv = '''
ds_achv/dt = -s_achv/tau_achv : 1 (clock-driven)
IsynEIv_post = -s_achv*(v-E_achv):1 (summed)
wach : 1 
'''
...
GABAv_eqs_i = '''
ds_GABAAv/dt = -s_GABAAv/tau_GABAAv : 1 (clock-driven)
Isyn_iiv_post = -s_GABAAv*(v-E_GABAAv):1 (summed)
wach : 1
'''
...
Ach_eqs_v = '''
ds_achv/dt = -s_achv/tau_achv : 1 (clock-driven)
Isyn_v_post = -s_achv*(v-E_achv):1 (summed)
wach : 1 
'''

Ach_eqs_PPv = '''
ds_achv/dt = -s_achv/tau_achv : 1 (clock-driven)
Isyn_ppv_post = -s_achv*(v-E_achv):1 (summed)
wach : 1 
'''

Ach_eqs_EPv = '''
ds_achv/dt = -s_achv/tau_achv : 1 (clock-driven)
Isyn_EPv_post = -s_achv*(v-E_achv):1 (summed)
wach : 1 
'''

Ach_eqs_PEv = '''
ds_achv/dt = -s_achv/tau_achv : 1 (clock-driven)
Isyn_PEv_post = -s_achv*(v-E_achv):1 (summed)
wach : 1 
'''

Ach_eqs_PE2Rv = '''
ds_achv/dt = -s_achv/tau_achv : 1 (clock-driven)
Isyn_PE2Rv_post = -s_achv*(v-E_achv):1 (summed)
wach : 1 
'''

Ach_eqs_PE2Lv = '''
ds_achv/dt = -s_achv/tau_achv : 1 (clock-driven)
Isyn_PE2Lv_post = -s_achv*(v-E_achv):1 (summed)
wach : 1 
'''

Ach_eqs_PE1Lv = '''
ds_achv/dt = -s_achv/tau_achv : 1 (clock-driven)
Isyn_PE1Lv_post = -s_achv*(v-E_achv):1 (summed)
wach : 1 
'''
Ach_eqs_PE1Rv = '''
ds_achv/dt = -s_achv/tau_achv : 1 (clock-driven)
Isyn_PE1Rv_post = -s_achv*(v-E_achv):1 (summed)
wach : 1 
'''
Ach_eqs_PE2R2v = '''
ds_achv/dt = -s_achv/tau_achv : 1 (clock-driven)
Isyn_PE2R2v_post = -s_achv*(v-E_achv):1 (summed)
wach : 1 
'''

Ach_eqs_PE2L2v = '''
ds_achv/dt = -s_achv/tau_achv : 1 (clock-driven)
Isyn_PE2L2v_post = -s_achv*(v-E_achv):1 (summed)
wach : 1 
'''

Ach_eqs_PE1L2v = '''
ds_achv/dt = -s_achv/tau_achv : 1 (clock-driven)
Isyn_PE1L2v_post = -s_achv*(v-E_achv):1 (summed)
wach : 1 
'''
Ach_eqs_PE1R2v = '''
ds_achv/dt = -s_achv/tau_achv : 1 (clock-driven)
Isyn_PE1R2v_post = -s_achv*(v-E_achv):1 (summed)
wach : 1 
'''

Ach_eqs_PE7v = '''
ds_achv/dt = -s_achv/tau_achv : 1 (clock-driven)
Isyn_PE7v_post = -s_achv*(v-E_achv):1 (summed)
wach : 1 
'''
Ach_eqs_PE8v = '''
ds_achv/dt = -s_achv/tau_achv : 1 (clock-driven)
Isyn_PE8v_post = -s_achv*(v-E_achv):1 (summed)
wach : 1 
'''
